...
class covidForm:
    def __init__(self):
        ...
        self.exposure2 = tkinter.Radiobutton(self.frame3_label, text='no', justify='center', font='Courier', variable=exposure, value=1)
        self.exposure2.grid(row=13, column=0)
        self.exposure3 = tkinter.Radiobutton(self.frame3_label, text='unsure', justify='center', font='Courier', variable=exposure, value=1)
