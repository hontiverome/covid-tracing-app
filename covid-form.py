...
class covidForm:
    def __init__(self):
        ...
        self.symptomsFelt1.place(x=250, y=40)
        ...
        self.symptomsFelt2.place(x=250, y=65)
        ...
        self.symptomsFelt3.place(x=250, y=90)
        ...
        self.symptomsFelt4.place(x=250, y=115)
        symptomsFelt5=tkinter.IntVar()
        self.symptomsFelt5 = tkinter.Checkbutton(self.frame3_label, text='common cold', justify='left', font='Courier', variable=symptomsFelt5, onvalue=1, offvalue=0)
        self.symptomsFelt5.place(x=250, y=140)
        symptomsFelt6=tkinter.IntVar()
        self.symptomsFelt6 = tkinter.Checkbutton(self.frame3_label, text='sore throat', justify='left', font='Courier', variable=symptomsFelt6, onvalue=1, offvalue=0)
        self.symptomsFelt6.place(x=500, y=40)
        symptomsFelt7=tkinter.IntVar()
        self.symptomsFelt7 = tkinter.Checkbutton(self.frame3_label, text='loss of taste or smell', justify='left', font='Courier', variable=symptomsFelt7, onvalue=1, offvalue=0)
        self.symptomsFelt7.place(x=500, y=65)
        symptomsFelt8=tkinter.IntVar()
        self.symptomsFelt8 = tkinter.Checkbutton(self.frame3_label, text='diarrhea', justify='left', font='Courier', variable=symptomsFelt8, onvalue=1, offvalue=0)
        self.symptomsFelt8.place(x=500, y=90)
        symptomsFelt9=tkinter.IntVar()
        self.symptomsFelt9= tkinter.Checkbutton(self.frame3_label, text='muscle/body pains', justify='left', font='Courier', variable=symptomsFelt9, onvalue=1, offvalue=0)   
        self.symptomsFelt9.place(x=500, y=115)
        symptomsFelt10=tkinter.IntVar()
        self.symptomsFelt10 = tkinter.Checkbutton(self.frame3_label, text='none', justify='left', font='Courier', variable=symptomsFelt10, onvalue=1, offvalue=0)
        self.symptomsFelt10.place(x=500, y=140)
        ...
        symptomsFelt_label.grid (row=0, column=1, padx=140)
    # test function
    def run(self):
