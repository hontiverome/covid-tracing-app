...
class covidForm:
    def __init__(self):
        ...
        self.symptomscFelt1.place(x=250, y=40)
        ...
        self.symptomscFelt2.place(x=250, y=65)
        ...
        self.symptomscFelt3.place(x=250, y=90)
        ...
        self.symptomscFelt4.place(x=250, y=115)
        ...
        self.symptomscFelt5.place(x=250, y=140)
        ...
        self.symptomscFelt6.place(x=500, y=40)
        ...
        self.symptomscFelt7.place(x=500, y=65)
        ...
        self.symptomscFelt8.place(x=500, y=90)
        ...
        self.symptomscFelt9.place(x=500, y=115)
        ...
        self.symptomscFelt10.place(x=500, y=140)
