...
class covidForm:
    def __init__(self):
        ...
        self.vaccinationStatus1 = tkinter.Radiobutton(self.frame3_label, bg='#a3d1fb', text='none            ', justify='center', font='Courier', variable=vacStat, value=1)
        self.vaccinationStatus1.grid(row=1, column=0)
        self.vaccinationStatus2 = tkinter.Radiobutton(self.frame3_label, bg='#a3d1fb', text='1st dose        ', justify='center', font='Courier', variable=vacStat, value=2)
        self.vaccinationStatus2.grid(row=2, column=0)
        self.vaccinationStatus3 = tkinter.Radiobutton(self.frame3_label, bg='#a3d1fb', text='2nd dose        ', justify='center', font='Courier', variable=vacStat, value=3)
        self.vaccinationStatus3.grid(row=3, column=0)
        self.vaccinationStatus4 = tkinter.Radiobutton(self.frame3_label, bg='#a3d1fb', text='1st booster shot', justify='left', font='Courier', variable=vacStat, value=4)
        self.vaccinationStatus4.grid(row=4, column=0)
        self.vaccinationStatus5 = tkinter.Radiobutton(self.frame3_label, bg='#a3d1fb', text='2nd booster shot', justify='left', font='Courier', variable=vacStat, value=5)
        ...
        self.symptomscFelt1 = tkinter.Checkbutton(self.frame3_label, bg='#a3d1fb', text='fever', justify='left', font='Courier', variable=symptomsFelt1, onvalue=1, offvalue=0)
        self.symptomscFelt1.place(x=280, y=40)
        symptomsFelt2=tkinter.IntVar()
        self.symptomscFelt2 = tkinter.Checkbutton(self.frame3_label, bg='#a3d1fb', text='cough', justify='left', font='Courier', variable=symptomsFelt2, onvalue=1, offvalue=0)
        self.symptomscFelt2.place(x=280, y=65)
        symptomsFelt3=tkinter.IntVar()
        self.symptomscFelt3 = tkinter.Checkbutton(self.frame3_label, bg='#a3d1fb', text='headache', justify='left', font   ='Courier', variable=symptomsFelt3, onvalue=1, offvalue=0)
        self.symptomscFelt3.place(x=280, y=90)
        symptomsFelt4=tkinter.IntVar()
        self.symptomscFelt4 = tkinter.Checkbutton(self.frame3_label, bg='#a3d1fb', text='shortness of breath', justify='left', font='Courier', variable=symptomsFelt4, onvalue=1, offvalue=0)
        self.symptomscFelt4.place(x=280, y=115)
        symptomsFelt5=tkinter.IntVar()
        self.symptomscFelt5 = tkinter.Checkbutton(self.frame3_label, bg='#a3d1fb', text='common cold', justify='left', font='Courier', variable=symptomsFelt5, onvalue=1, offvalue=0)
        self.symptomscFelt5.place(x=280, y=140)
        symptomsFelt6=tkinter.IntVar()
        self.symptomscFelt6 = tkinter.Checkbutton(self.frame3_label, bg='#a3d1fb', text='sore throat', justify='left', font='Courier', variable=symptomsFelt6, onvalue=1, offvalue=0)
        self.symptomscFelt6.place(x=520, y=40)
        symptomsFelt7=tkinter.IntVar()
        self.symptomscFelt7 = tkinter.Checkbutton(self.frame3_label, bg='#a3d1fb', text='loss of taste or smell', justify='left', font='Courier', variable=symptomsFelt7, onvalue=1, offvalue=0)
        self.symptomscFelt7.place(x=520, y=65)
        symptomsFelt8=tkinter.IntVar()
        self.symptomscFelt8 = tkinter.Checkbutton(self.frame3_label, bg='#a3d1fb', text='diarrhea', justify='left', font='Courier', variable=symptomsFelt8, onvalue=1, offvalue=0)
        self.symptomscFelt8.place(x=520, y=90)
        symptomsFelt9=tkinter.IntVar()
        self.symptomscFelt9= tkinter.Checkbutton(self.frame3_label, bg='#a3d1fb', text='muscle/body pains', justify='left', font='Courier', variable=symptomsFelt9, onvalue=1, offvalue=0)   
        self.symptomscFelt9.place(x=520, y=115)
        symptomsFelt10=tkinter.IntVar()
        self.symptomscFelt10 = tkinter.Checkbutton(self.frame3_label, bg='#a3d1fb', text='none', justify='left', font='Courier', variable=symptomsFelt10, onvalue=1, offvalue=0)
        ...
        self.exposure1 = tkinter.Radiobutton(self.frame3_label, bg='#a3d1fb', text='yes   ', justify='center', font='Courier', variable=exposure, value=1)
        self.exposure1.grid(row=12, column=0)
        self.exposure2 = tkinter.Radiobutton(self.frame3_label, bg='#a3d1fb', text='no    ', justify='center', font='Courier', variable=exposure, value=2)
        self.exposure2.grid(row=13, column=0)
        self.exposure3 = tkinter.Radiobutton(self.frame3_label, bg='#a3d1fb', text='unsure', justify='center', font='Courier', variable=exposure, value=3)
        ...
        self.covidTest1 = tkinter.Radiobutton(self.frame3_label, bg='#a3d1fb', text='no           ', justify='center', font='Courier', variable=covidTest, value=1)
        self.covidTest1.grid(row=12, column=1)
        self.covidTest2 = tkinter.Radiobutton(self.frame3_label, bg='#a3d1fb', text='yes, positive', justify='center', font='Courier', variable=covidTest, value=2)
        self.covidTest2.grid(row=13, column=1)
        self.covidTest3 = tkinter.Radiobutton(self.frame3_label, bg='#a3d1fb', text='yes, negative', justify='center', font='Courier', variable=covidTest, value=3)
        self.covidTest3.grid(row=14, column=1)
        self.covidTest4 = tkinter.Radiobutton(self.frame3_label, bg='#a3d1fb', text='yes, pending ', justify='center', font='Courier', variable=covidTest, value=4)
        ...
        self.submit = tkinter.Button(self.window, bg='#ffffff', text="Submit")
